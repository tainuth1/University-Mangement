...
<link rel="stylesheet" href="css/student-profile.css">
        ...
        <div class="dashboard-content">
            <div class="title-locate">
                ...
                <div class="locate">
                    <p>Admin / <span>Edit Profile</span></p>
                </div>
            </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="input-field-wrap">
                        ...
                        <div class="">
                            ...
                            <input class="input-info edit-profile" type="date" name="dateOfBirth" value="<?= $row['dateOfBirth'] ?>">
                        </div>
                        <div class="">
                    ...
                    <div class="btn-wrapper">
                        <button class="create-btn" name="admin" type="submit">Update</button>
                        <!-- <button name="cancel-edit">Cancel</button> -->
                        <a href="profile.php?id=<?= $row['admin_id'] ?>" class="cancel">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
