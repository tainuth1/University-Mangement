                    ...
                    <div class="profile-content">
                        <div class="profile-img-names-dis">
                            <div class="pro-img-wrapper">
                                <img src="profile/<?= $row['profile'] == 'profile.jpg' ? 'noProfile.jpg' : $row['profile'] ?>" alt="">
                                <?php 
                                    if($row['role'] == 'Administrator'){
                                        ?>
                                            <form class="choose-profile" method="post">
                                                <div class="">
                        ...
                        <div class="edit-pro">
                            ...
                            <a href="edit-profile-teacher.php?teacherID=<?= $row['teacher_id'] ?>">
